...
export default function Signup() {
    ...
    return (
        <div className="min-h-screen bg-[#0B0F14] text-white flex items-center justify-center p-4 relative overflow-hidden">
            {/* Background Effects */}
            <div className="absolute top-0 right-1/2 translate-x-1/2 w-[800px] h-[500px] bg-blue-500/10 blur-[120px] rounded-full opacity-20 pointer-events-none" />
                    ...
                    <Button
                        ...
                        onClick={async () => {
                            try {
                                ...
                                toast({ title: "Account Created", description: "Welcome to Fintech AI!" });
                                setLocation("/dashboard");
                            } catch (error: any) {
                                toast({
